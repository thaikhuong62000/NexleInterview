...
export function getActiveRouteName(
	...
	if (!route.state) return route.name as keyof ApplicationStackParamList;

	// Recursive call to deal with nested routers
	return getActiveRouteName(
		route.state as NavigationState<ApplicationStackParamList>
	);
}
 ...
 * @see https://reactnavigation.org/docs/navigating-without-navigation-prop/
 */
export function navigate<T extends keyof ApplicationStackParamList>(
	name: T,
